      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {features.map((item, index) => (
            ...
            >
              {/* Icon */}
              <div className="w-14 h-14 mx-auto flex items-center justify-center rounded-xl bg-green-100 text-blue-700 group-hover:bg-blue-700 group-hover:text-white transition mb-4">
                {item.icon}
              </div>
